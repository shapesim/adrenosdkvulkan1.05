...
protected:
    ...
    VkPipeline              mPipelineBlur;
    VkPipeline              mPipelineGreyscale;
    VkPipeline              mPipelineWibble;
    VkPipeline              mPipelineInvert;
    ...
    TextureObject mTexStone;
    TextureObject mTexRock;
    TextureObject mTexBee;

    float mNextTextureChangeTime;
