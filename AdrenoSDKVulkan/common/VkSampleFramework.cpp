...
void VkSampleFramework::PointerDownEvent(uint32_t iPointerID, float xPos, float yPos)
{
    if (iPointerID==0)
    {
        mTouchX = xPos*mWidth;
...
void VkSampleFramework::PointerUpEvent(uint32_t iPointerID, float xPos, float yPos)
{
    if (iPointerID==0)
    {
        mTouchX = xPos*mWidth;
...
void VkSampleFramework::PointerMoveEvent(uint32_t iPointerID, float xPos, float yPos)
{
    if (iPointerID==0)
    {
        mTouchX = xPos*mWidth;
