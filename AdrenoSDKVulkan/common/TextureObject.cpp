...
TKTXErrorCode TextureObject::LoadKTXFromMemory(VkSampleFramework* sample, const uint8_t* dataInMemory, uint32_t filesize, TextureObject* pTextureObject)
{
...
bool TextureObject::FromKTXFile(VkSampleFramework* sample, const char* filename, TextureObject* pTextureObject)
{
...
bool TextureObject::FromTGAImageData(VkSampleFramework *sample, TextureObject *textureObject, uint32_t *imageData)
{
